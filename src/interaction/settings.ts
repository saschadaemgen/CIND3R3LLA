...
const PERSONA_EN: PersonaStrings = {
  ...
  musicGenreYes: '🎵 Yes, I have {genre}: {tracks}. Want the playlist, or shall I put one on?',
  ...
  musicUploadTooLarge: '🎧 That file is bigger than I am allowed to carry: {limit} is my line.',
...
const PERSONA_DE: PersonaStrings = {
  ...
  musicSendFailed: '🎵 Gefunden habe ich es, aber das Senden ist bei mir gescheitert. Es ist notiert; frag mich gleich nochmal.',
  musicUploadNotAudio: '🎧 Ich sende nur MP3-Dateien weiter. Das ist keine, also lasse ich sie liegen.',
  musicUploadTooLarge: '🎧 Diese Datei ist groesser, als ich tragen darf: {limit} ist meine Grenze.',
