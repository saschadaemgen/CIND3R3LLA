...
export const DEFAULT_HELP_TEMPLATE: Record<HelpLang, string> = {
  en: `🕯️ I am *{wake}*{label}. This is a public group, and I keep a public web archive of what its members choose to publish.
...
✨ *What you can ask me*
{commands}`,
  de: `🕯️ Ich bin *{wake}*{label}. Dies ist eine öffentliche Gruppe, und ich führe ein öffentliches Web-Archiv dessen, was ihre Mitglieder veröffentlichen möchten.
