  ...
  setNavItems([
    ...
    },
    {
      ...
      children: [
        ...
        {
          key: 'interaction:guards',
          href: '/interaction/guards',
          label: 'Guards',
          icon: icon('interaction'),
        },
        {
          key: 'interaction:followup',
          href: '/interaction/followup',
          label: 'Follow-up',
          icon: icon('interaction'),
        },
        {
        ...
        {
          key: 'interaction:replies',
          href: '/interaction/replies',
          label: 'Replies',
          icon: icon('interaction'),
        },
        {
          key: 'interaction:nicknames',
          href: '/interaction/nicknames',
          label: 'Nicknames',
          icon: icon('interaction'),
        },
        {
          key: 'interaction:consent',
          href: '/interaction/consent',
          label: 'Consent',
          icon: icon('interaction'),
        },
        {
          key: 'interaction:voice',
          href: '/interaction/voice',
          label: 'Voice',
          icon: icon('interaction'),
        },
        {
          key: 'interaction:archiving',
          href: '/interaction/archiving',
          label: 'Archiving',
          icon: icon('interaction'),
        },
        {
          key: 'interaction:diagnostics',
          href: '/interaction/diagnostics',
          label: 'Diagnostics',
          icon: icon('interaction'),
        },
      ],
