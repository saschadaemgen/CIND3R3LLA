...
console.log(
  `copied htmx.min.js, webauthn-browser.js, auth.js, admin-effects.js, admin-navigation.js, admin-setup-wizard.js, admin-access-control.js, admin-model-catalog.js, site avatar + ${fontCount} fonts -> public/assets/`,
);
