...
async function main(): Promise<void> {
  ...
  /* ── 8. The previews carry the SELECTED BOT'S voice (D-229) ─────────────── */

  console.log("\n8. The previews carry the selected bot's dials, character and origin");
  ...
  /* ── 8b. The context-size card measures the prompt she is SENT ───────────── */

  console.log('\n8b. The Interaction page measures a prompt with the voice section in it');
